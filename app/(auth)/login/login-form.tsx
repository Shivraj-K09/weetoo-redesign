...
// Updated SVGs for social logins with correct brand colors
const GoogleIcon = () => (
  <svg
    width="24"
    height="24"
...
export function LoginForm() {
  ...
  return (
    <form className="max-w-[450px] w-full mx-auto border border-border bg-card p-8 flex flex-col gap-6 rounded-none">
      <div className="mb-2">
        <h2 className="text-2xl font-bold text-center rounded-none">
          Welcome back,
        </h2>
        <div className="text-center text-base mt-1">
          Sign in to access your WEETOO account.
        </div>
      </div>

import { CoinFuturesComparison } from "@/components/exchange/coin-future-comparison";
import { Metadata } from "next";

export const metadata: Metadata = {
  title: "Coin Futures Comparison",
  description:
    "Compare Korean cryptocurrency exchanges - fees, features, security, and trading pairs",
};

export default function CoinFutures() {
  return (
            ...
            <div className="container mx-auto max-w-3xl space-y-8">
              <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight">
                  Coin Futures Exchange Comparison
                </h1>
